...
\newcommand{\myTitle}{Vector Tiles from OpenStreetMap\xspace}
...
\newcommand{\myKeywords}{OpenStreetMap, Mapbox, Vector Tiles, PostGIS}
...
%	MARGINS
%-------------------------------------
\usepackage[left=2.5cm,right=3.2cm,top=2.5cm,bottom=3cm]{geometry}
