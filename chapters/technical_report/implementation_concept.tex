...
\marginpar{The section \hyperref[data_style]{\emph{Data Style}} provides more details.}The data style is a description of the vector tile structure and the SQL queries to fetch the data.
